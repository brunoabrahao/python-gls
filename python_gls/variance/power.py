"""VarPower: power of covariate variance function."""
...
class VarPower(VarFunc):
    """Variance proportional to a power of a covariate.

    Models: sd(y_i) = |v_i|^delta where v_i is the covariate value.

    Equivalent to R's `varPower(form = ~covariate)`.
